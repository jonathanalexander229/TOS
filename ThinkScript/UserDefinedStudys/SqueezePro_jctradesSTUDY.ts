...
# def breakoutUp = price crosses above squeezeline and ExtrSqueeze;
# def breakoutDown = price crosses below squeezeline and ExtrSqueeze;

# ## Plot breakout signals
# plot UpSignal = breakoutUp;
# plot DownSignal = breakoutDown;
